...
class Genotype:
    ...
    def label_barcodes(self):
        ...
        self.cells.loc[(self.cells['label'] == 'multi') & (self.cells['alternate_count'] < means['alternate_count']), 'label'] = 'background'
        self.cells.loc[(self.cells['label'] == 'multi') & (self.cells['reference_count'] < means['reference_count']), 'label'] = 'background'
